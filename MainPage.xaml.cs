...
namespace Rekenmachine
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public void equals_click(object sender, RoutedEventArgs e)
        {
            ...
            string uitkomst = getal1.ToString() + operation.ToString() + getal2.ToString() + "=" + result.ToString();
        ...
        //operand1 word input het slaat dus alles op in de input en operand1 word alleen gebruikt voor operators
        ...
        //try en catch zorgt ervoor dat de applicatie niet crashed wanneer je op del drukt als er geen cijfers meer staan
